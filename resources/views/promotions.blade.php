...
<div class="bg-salon-bg py-16 sm:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="mt-4 max-w-2xl text-lg text-salon-textLight mx-auto">Manfaatkan penawaran dan paket spesial kami yang sedang berlangsung.</p>
        </div>

        <div class="space-y-12">
            @forelse($promotions as $promotion)
                <div class="bg-white overflow-hidden shadow-sm hover:shadow-md transition duration-300 rounded-2xl border border-salon-beige flex flex-col md:flex-row group">
                    @if($promotion->image)
                    ...
                    <div class="p-8 {{ $promotion->image ? 'md:w-2/3' : 'w-full' }} flex flex-col justify-center">
                        <div class="inline-flex items-center w-fit text-sm font-medium text-salon-gold bg-salon-cream px-3 py-1 rounded-full mb-3">
