        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-stone-50">
            <div>
                <a href="/" class="flex flex-col items-center gap-2">
                    ...
                    <span class="text-2xl font-serif font-bold text-rose-500">Eeva Salon</span>
                </a>
            </div>

            <div class="w-full sm:max-w-md mt-8 px-6 py-8 bg-white shadow-lg border border-gray-100 overflow-hidden sm:rounded-2xl">
                {{ $slot }}
            </div>
        </div>
    </body>
