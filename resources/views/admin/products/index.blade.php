...
@section('content')
    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <a href="{{ route('admin.products.create') }}" class="inline-flex justify-center items-center px-4 py-2.5
                sm:py-2 bg-salon-gold border-transparent rounded-lg font-bold text-sm text-white hover:bg-salon-goldHover
