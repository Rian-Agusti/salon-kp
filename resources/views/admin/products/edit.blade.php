    ...
    <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="p-6">
        ...
        <div class="mb-6">
            ...
            <textarea name="description" id="description" rows="4"
                      class="w-full rounded-md border-gray-300 shadow-sm focus:border-rose-500 focus:ring focus:ring-rose-200 focus:ring-opacity-50">{{ old('description', $product->description) }}</textarea>
        ...
        <div class="flex justify-end pt-4 border-t border-gray-200">
            ...
            <button type="submit" class="bg-rose-500 hover:bg-rose-600 text-white font-medium py-2 px-4 rounded shadow-sm">Update Product</button>
        </div>
    </form>
</div>
@endsection
