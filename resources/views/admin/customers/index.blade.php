...
@section('content')
    <div class="flex w-full sm:w-auto gap-2 mb-4 ">
        <form action="{{ route('admin.customers.index') }}" method="GET"
            class="flex-grow sm:flex-grow-0 flex items-center border border-gray-300 rounded-md overflow-hidden bg-white shadow-sm focus-within:ring-1 focus-within:ring-salon-gold focus-within:border-salon-gold">
            <input type="text" name="search" value="{{ request('search') }}"
                placeholder="Cari nama, no. telp, atau email..." class="w-full border-none focus:ring-0 text-sm px-3 py-2">
            <button type="submit"
                class="px-3 py-2 bg-gray-50 text-gray-600 hover:bg-gray-100 hover:text-gray-900 border-l border-gray-300">
