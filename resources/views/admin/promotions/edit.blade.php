...
@section('header', 'Edit Promotion: ' . $promotion->title)

@section('content')
<div class="bg-white rounded-lg shadow-sm border border-gray-200">
    <form action="{{ route('admin.promotions.update', $promotion) }}" method="POST" enctype="multipart/form-data" class="p-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                @if($promotion->image)
                    <div class="mb-2">
                        <img src="{{ Storage::url($promotion->image) }}" alt="Current Image" class="h-20 w-32 object-cover rounded border">
                    </div>
                @endif
