    ...
    $totalDuration = 0;
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                <h3 class="text-sm font-bold text-salon-text uppercase tracking-wider mb-4 border-b pb-2">Detail Transaksi</h3>
                <div class="space-y-3">
                    <div class="flex items-start">
                        ...
                        <div>
                            <p class="text-xs text-gray-500 uppercase">Sumber Reservasi</p>
                            @if($reservation->source == 'online')
                                <span class="px-2 mt-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">Online via Website</span>
                            @else
                                <span class="px-2 mt-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-purple-100 text-purple-800">Offline via Admin</span>
                            @endif
                        </div>
                    </div>
                    <div class="flex items-start">
