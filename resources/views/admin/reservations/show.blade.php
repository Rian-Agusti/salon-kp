...
<div class="mb-4 flex justify-between items-center">
    <a href="{{ route('admin.reservations.index') }}" class="text-gray-600 hover:text-gray-900 flex items-center">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-6">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex justify-between items-start mb-6">
                <div>
                    <h2 class="text-2xl font-bold text-rose-500 mb-1">{{ $reservation->reservation_code }}</h2>
            ...
            <div class="border-t border-gray-100 pt-6">
                <h3 class="text-lg font-bold text-gray-900 mb-4">Services Booked</h3>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @foreach($reservation->reservationItems as $item)
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">Rp {{ number_format($item->service_price, 0, ',', '.') }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                        <tfoot class="bg-gray-50">
                            <tr>
                                <th scope="row" class="px-6 py-4 text-right text-sm font-bold text-gray-900">Total</th>
                                <td class="px-6 py-4 text-center text-sm font-bold text-gray-900">{{ $totalDuration }} mins</td>
                                <td class="px-6 py-4 text-right text-lg font-bold text-rose-600">Rp {{ number_format($totalPrice, 0, ',', '.') }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
            ...
            <div class="border-t border-gray-100 pt-6 mt-6">
                <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-2">Customer Notes</h3>
    ...
    <div class="space-y-6">
        <!-- Update Status Box -->
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 border-b pb-2">Update Status</h3>
        ...
        <!-- Schedule Box -->
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 border-b pb-2">Schedule</h3>
            <div class="space-y-3">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-900">{{ $reservation->booking_date->format('l, d M Y') }}</p>
                    </div>
                </div>
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-900">{{ \Carbon\Carbon::parse($reservation->booking_time)->format('H:i') }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Customer Box -->
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 border-b pb-2">Customer Info</h3>
            <div class="space-y-3">
            ...
            <div class="mt-4 pt-4 border-t border-gray-100">
                <a href="{{ route('admin.customers.show', $reservation->user_id) }}" class="text-rose-500 hover:text-rose-700 text-sm font-medium">View Customer Profile &rarr;</a>
            </div>
        </div>
    </div>
</div>
