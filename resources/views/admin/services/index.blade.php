...
<div class="mb-6 flex justify-between items-center">
    <div></div>
    <a href="{{ route('admin.services.create') }}" class="bg-rose-500 hover:bg-rose-600 text-white font-medium py-2 px-4 rounded shadow-sm inline-flex items-center">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    @if($service->image)
                                        <img class="h-10 w-10 rounded object-cover" src="{{ Storage::url($service->image) }}" alt="">
                                    @else
