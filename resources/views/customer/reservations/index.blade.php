...
@section('content')
                                ...
                                <div class="px-6 py-6 sm:px-8">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="ml-2 flex-shrink-0 flex">
                                            <p
                                                class="px-3 py-1 inline-flex text-xs font-bold rounded-full {{ $reservation->status->value === 'confirmed' ? 'bg-blue-50 text-blue-600 border border-blue-200' : 'bg-amber-50 text-amber-600 border border-amber-200' }}">
    ...
    <div>
        ...
        @if($completedReservations->count() > 0)
            <div
                class="bg-white shadow-sm border border-salon-beige rounded-2xl overflow-hidden opacity-80 hover:opacity-100 transition duration-300">
                <ul class="divide-y divide-gray-100">
                            ...
                            <a href="{{ route('customer.reservations.show', $reservation) }}" class="block">
                                <div class="px-6 py-5 sm:px-8">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="ml-2 flex-shrink-0 flex">
                                            <p
                                                class="px-3 py-1 inline-flex text-xs font-bold rounded-full {{ $reservation->status->value === 'completed' ? 'bg-emerald-50 text-emerald-600 border border-emerald-200' : 'bg-red-50 text-red-600 border border-red-200' }}">
