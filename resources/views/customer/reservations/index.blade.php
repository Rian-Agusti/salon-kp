                                ...
                                <div class="px-4 py-4 sm:px-6">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="ml-2 flex-shrink-0 flex">
                                            <p
                                                class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $reservation->status === 'confirmed' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
                            ...
                            <a href="{{ route('customer.reservations.show', $reservation) }}" class="block hover:bg-gray-50">
                                <div class="px-4 py-4 sm:px-6">
                                    ...
                                    <div class="mt-2 sm:flex sm:justify-between">
                                        <div class="sm:flex">
                                            <p class="flex items-center text-sm text-gray-500">
                                                {{ $reservation->booking_date->format('M d, Y') }} at
                                                {{ \Carbon\Carbon::parse($reservation->booking_time)->format('H:i') }}
                                            </p>
                                        </div>
                                    </div>
