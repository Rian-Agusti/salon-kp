        ...
        <div class="bg-white rounded-3xl shadow-sm hover:shadow-md transition duration-300 overflow-hidden border border-salon-beige">
            <div class="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div class="ml-5">
                                ...
                                @if($setting->phone)
                                    @php
                                        ...
                                        $waPhone = preg_replace('/[^0-9]/', '', $setting->phone);
                                        // If starts with 0, replace with 62 (assuming Indonesia)
                                        if (substr($waPhone, 0, 1) == '0') {
                                            $waPhone = '62' . substr($waPhone, 1);
                                        }
                                    @endphp
                                    <a href="https://wa.me/{{ $waPhone }}" target="_blank" class="mt-3 inline-flex items-center text-sm font-medium text-green-600 hover:text-green-700 bg-green-50 px-3 py-1.5 rounded-full transition">
                ...
                <div class="p-0 h-[400px] md:h-auto w-full relative bg-gray-100">
                    ...
                    @else
                        <div class="w-full h-full bg-gray-100 flex flex-col items-center justify-center text-gray-400 absolute inset-0">
